...
<html lang="en" class="scroll-smooth">
  ...
  <body class="bg-slate-200 font-display">
    ...
    <div class="container mx-auto">
      <div class="md:8/12 mx-auto mt-10 w-9/12 text-zinc-800 lg:w-3/5">
        <!-- Header -->
          ...
          <!-- ! Edit Profile Contact -->
            ...
            <div id="edit-contact" class="flex-0 hidden basis-[330px] self-start rounded-2xl border-2 border-zinc-800 bg-slate-300 px-4 py-6">
              ...
              <div class="mx-4 mt-8 border-t-2 border-zinc-800">
                ...
                <button class="mt-6 h-9 w-full rounded-2xl bg-yellow-400 text-sm font-bold hover:bg-yellow-500 focus:ring-4 focus:ring-blue-400 md:mt-8 md:text-lg" type="button" data-modal-target="profileModal" data-modal-toggle="profileModal">Edit Profile Info</button>
              </div>
            </div>
        ...
        <div class="relative max-h-full w-full max-w-lg">
          ...
          <div class="relative rounded-lg bg-slate-300 shadow">
            ...
            <div class="flex items-center space-x-2 rounded-b border-t border-gray-200 p-6 dark:border-gray-600">
              <button data-modal-hide="profileModal" type="submit" class="rounded-2xl bg-yellow-400 px-5 py-2.5 text-center text-base font-semibold text-zinc-800 hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-blue-400">Confirm Edit</button>
