  ...
  <body class="bg-slate-200 font-display">
    ...
    <div class="container mx-auto h-[calc(100vh-110px)] overflow-auto">
      <div class="flex flex-col justify-center items-center h-full p-4  text-zinc-800">
        ...
        <h1 class="md: mt-6 text-3xl font-bold lg:text-5xl">500 Internal Server Error</h1>
        <p class="mt-6 w-5/6 text-center text-lg font-normal lg:w-1/2 lg:text-3xl">Oh no! Our server is having a bad day. We're working to fix the issue as quickly as possible. Please try again later.</p>
      </div>
    </div>
