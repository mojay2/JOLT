  ...
  <body class="bg-slate-200 font-display">
    ...
    <div class="container mx-auto h-[calc(100vh-110px)] overflow-auto">
      <div class="flex flex-col justify-center items-center h-full p-4  text-zinc-800">
        ...
        <h1 class="md: mt-6 text-3xl font-bold lg:text-5xl">401 Unauthorized Access</h1>
        <p class="mt-6 w-5/6 text-center text-lg font-normal lg:w-1/2 lg:text-3xl">Sorry, you're not authorized to access this page. Please log in or contact support if you think this is an error.</p>
      </div>
    </div>
